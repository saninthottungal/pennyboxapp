...
class DeleteAccountSheet extends StatelessWidget with SheetMixin {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const SheetHeader(title: 'Delete Account?'),
          const SizedBox(
            width: double.infinity,
            child: Text(
              "Caution: All transactions in this account will also be deleted,"
